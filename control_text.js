    ...
    pizzas.forEach(pizza => {
        let setSliders = setPizza(`${pizza.name}`, 0);
            let control_text = setSliders("slidersXPos", "sliceSliderYPos");
                eval(control_text[0]);
                eval(control_text[1]);
                let eval_text = control_text[2](pizza.sliceSlider.value(), 32, (appWidth * 0.031), (appWidth * 0.003));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
                eval_text = control_text[2]("steps (1/" + pizza.stepFrac.toFixed(3) + " note)", 16, 0, (appWidth * 0.006));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
            control_text = setSliders("slidersXPos", "toothSliderYPos");
                eval_text = control_text[2](pizza.toothSlider.value(), 32, (appWidth * 0.031), (appWidth * 0.003));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
                eval_text = control_text[2]("÷", 19, 36, (appHeight * -0.022));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
                eval_text = control_text[2]("time units (" + timeUnit.toFixed(3) + " s)", 16, 0, (appWidth * 0.006));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
            control_text = setSliders("rotateSliderXPos", "rotateSliderYPos");
                eval_text = control_text[2](pizza.rotateSlider.value(), 32, (appWidth * 0.031), (appWidth * 0.003));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
                eval_text = control_text[2]("step rotations", 16, 0, (appWidth * 0.006));
                    eval(eval_text[0]);
                    eval(eval_text[1]);
