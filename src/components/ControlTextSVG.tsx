...
export default function ControlTextSVG({
  ...
  return (
    <g fill={fill} stroke="none">
      {/* Slice count */}
      <text
        x={slidersX - ow * SPACING.CONTROL_TEXT_OFFSET_X}
        y={sliceY - ow * SPACING.CONTROL_TEXT_OFFSET_Y}
        fontSize={lgSize}
      >
        {pizza.slices}
      </text>
      <text x={slidersX} y={sliceY - ow * SPACING.CONTROL_TEXT_SMALL_Y_OFFSET} fontSize={smSize}>
      ...
      <text
        x={slidersX - ow * SPACING.CONTROL_TEXT_OFFSET_X}
        y={toothY - ow * SPACING.CONTROL_TEXT_OFFSET_Y}
        fontSize={lgSize}
      >
        {pizza.numTeeth}
      </text>
      <text
        x={slidersX - ow * SPACING.DIV_SYMBOL_X_OFFSET}
      ...
      {/* Rotation count */}
      <text
        x={rotateX - ow * SPACING.CONTROL_TEXT_OFFSET_X}
        y={rotateY - ow * SPACING.CONTROL_TEXT_OFFSET_Y}
        fontSize={lgSize}
      >
        {rotation}
      </text>
      <text x={rotateX} y={rotateY - ow * SPACING.CONTROL_TEXT_SMALL_Y_OFFSET} fontSize={smSize}>
        step rotations
      </text>
      <text x={rotateX - ow * SPACING.ROTATION_LABEL_X_OFFSET} y={rotateY} fontSize={smSize}>
        step
      </text>
    </g>
  );
